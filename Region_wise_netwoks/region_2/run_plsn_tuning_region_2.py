...
def main():
    parser = argparse.ArgumentParser(description="Region 2 PLSN hyperparameter sweep.")
    ...
    logger = logging.getLogger("Region2-PLSN-Tuning")
    ...
    csv_path, summary_path = tuner.export_results(results_df, prefix=f"region2_plsn_tuning_{ts}")
    ...
    print(f"\n[OK] Region 2 PLSN Tuning completed.")
