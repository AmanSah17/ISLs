...
# Project root directory for Region 2
REGION_DIR = os.path.dirname(os.path.abspath(__file__))

# ── Input Data ────────────────────────────────────────────────────────────────
DATA_FILE_PATH = os.path.join(REGION_DIR, "region_2_ais.parquet")
...
# ── CLIQUE Parameters ────────────────────────────────────────────────────────
CLIQUE_GRID_DIVISIONS_K     = 500
CLIQUE_DENSITY_THRESHOLD_R  = 0.0003
...
TUNING_MIN_PORT_POINTS    = 50 # Smaller region
TUNING_EXPECTED_PORTS_MIN = 10 
TUNING_EXPECTED_PORTS_MAX = 50 
TUNING_TOP_MAPS           = 5
