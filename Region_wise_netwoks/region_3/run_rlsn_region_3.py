...
def main():
    ...
    logger = logging.getLogger("Region3_RLSN")

    logger.info("Starting RLSN Extraction for Region 3...")
    ...
    logger.info("Region 3 RLSN Extraction completed. Generated %d routes.", len(rlsn_routes))
