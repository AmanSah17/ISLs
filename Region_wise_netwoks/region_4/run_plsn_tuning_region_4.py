...
def main():
    parser = argparse.ArgumentParser(description="Region 4 PLSN hyperparameter sweep.")
    ...
    logger = logging.getLogger("Region4-PLSN-Tuning")
    ...
    csv_path, summary_path = tuner.export_results(results_df, prefix=f"region4_plsn_tuning_{ts}")
    ...
    print(f"\n[OK] Region 4 PLSN Tuning completed.")
