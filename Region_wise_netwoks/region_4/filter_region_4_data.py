...
GEOJSON_PATH = os.path.join(REGION_ROOT, "region_4.geojson")
...
OUTPUT_PARQUET = os.path.join(REGION_ROOT, "region_4_ais.parquet")

def filter_data():
    print(f"Loading Region 4 polygon from {GEOJSON_PATH}...")
    ...
    print(f"Final rows in Region 4: {len(df_final)}")
