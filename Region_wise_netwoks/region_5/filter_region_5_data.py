...
GEOJSON_PATH = os.path.join(REGION_ROOT, "region_5.geojson")
...
OUTPUT_PARQUET = os.path.join(REGION_ROOT, "region_5_ais.parquet")

def filter_data():
    print(f"Loading Region 5 polygon from {GEOJSON_PATH}...")
    ...
    print(f"Final rows in Region 5: {len(df_final)}")
