...
def main():
    parser = argparse.ArgumentParser(description="Region 5 PLSN hyperparameter sweep.")
    ...
    logger = logging.getLogger("Region5-PLSN-Tuning")
    ...
    csv_path, summary_path = tuner.export_results(results_df, prefix=f"region5_plsn_tuning_{ts}")
    ...
    print(f"\n[OK] Region 5 PLSN Tuning completed.")
