...
def main():
    parser = argparse.ArgumentParser(description="Region 1 PLSN hyperparameter sweep.")
    ...
    logger = logging.getLogger("Region1-PLSN-Tuning")
    ...
    csv_path, summary_path = tuner.export_results(results_df, prefix=f"region1_plsn_tuning_{ts}")
    ...
    print(f"\n[OK] Region 1 PLSN Tuning completed.")
